...
class ProfileFragment : Fragment() {
    ...
    private lateinit var textDegree: EditText
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textDegree = view.findViewById(R.id.profile_degree)
    ...
    private fun initializePopupMenu(popupMenu: PopupMenu) {
    ...
    private fun deleteImage(imagePath: String) {
        val file = File("$imagePath/profile.jpg")
        if (file.exists()) {
            file.delete()
        }
    }
...
//        Log.d("imagePath", requireContext().filesDir.path)
//        Log.d("imagePathReal", directory.absolutePath)
